# kaggle_Titanic
Student Project in SPICED Academy Berlin, week 02. My trial on the legendary Titanic ML competition: using machine learning to create a model that predicts which passengers survived the Titanic shipwreck.
